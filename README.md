...
||
| :---: |
| <img src="WebForms-MovieManager/Assets/request_error_handling_aditional.svg" width="400"> |
...
**Global.asax** Application-Level Error Handling
 ...
 ```csharp 
    void Application_BeginRequest(object sender, EventArgs e){// code goes here}
   
    void Application_EndRequest(object sender, EventArgs e){// code goes here}

    protected void Application_Error(object sender, EventArgs e){// code goes here}

    private void RedirectToErrorPage(Exception ex, HttpContext context){// code goes here}
...
| Components Diagram|
| :---: |
| <img src="WebForms-MovieManager/Assets/Events/2-Component-Diagram.svg" width="400"> |
...
| Key Benefits | |
| --- | --- |
| Separation of Concerns| Presenter handles logic, View handles UI|
| Testability| Components can be tested independently|
| Maintainability| Each component is self-contained|
| Event-Driven| Components communicate without tight coupling|
| Consistent Pattern| All Components follow the same MVP structure|
